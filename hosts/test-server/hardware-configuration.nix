...
# nixos-generate-config --root /mnt --show-hardware-config > hosts/test-server/hardware-configuration.nix
...

{
  ...
  boot = {
    initrd.availableKernelModules = [ "uhci_hcd" "ehci_pci" "ata_piix" "megaraid_sas" "usb_storage" "sd_mod" ];
